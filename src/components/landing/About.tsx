...
import { ITERATION_STRING, ITERATION_WORD } from '@/constants';
...
const Beginner = () => {
    return <div className='text-lg'>
        <p className="mb-4">Make, Build, Create & Learn. Join GunnHacks {ITERATION_STRING}, the {ITERATION_WORD} iteration of Gunn’s annual hackathon!</p>
        ...
        <p className="mb-4">
            ...
            rated by a panel of judges, and the winners get cool swags and prizes! At GunnHacks {ITERATION_STRING}, the project can literally be anything, from games to data visualization,
        ...
        <p className="mb-4">
            GunnHacks {ITERATION_STRING} is a 24-hour event, which means participants are given a 24-hour time frame to complete your project. (Of course, most participants
        ...
        <p className="mb-4">
            GunnHacks {ITERATION_STRING} is a great opportunity for beginners to learn and become acquainted with coding. It’s a lot of fun, too, with a host of mini-events
        ...
        <p className="mb-4">
            GunnHacks {ITERATION_STRING} is dedicated to an inclusive experience for all. All hackers are expected to follow the <a href="/conduct" target="_blank" rel="noopener noreferrer">GunnHacks Code of Conduct</a>.
        </p>
...
const Veteran = () => {
    return <div className='text-lg'>.
        <p className="mb-4">Make, Build, Create & Learn. It’s GunnHacks {ITERATION_STRING}, the {ITERATION_WORD} iteration of Gunn’s annual hackathon!</p>
